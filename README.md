...
**NOTE:** It was discovered that the prioritized code is missing the weights when training the network. This element is missing on most of the online examples, so I am working on a new version of the prioritized code. I expect to be finished by 09/15/2018.
